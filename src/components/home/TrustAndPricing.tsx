...
export function TrustAndPricing() {
  ...
  // Scroll detection to show sticky CTA only when pricing section is visible
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <section ref={sectionRef} className="py-32 bg-[#050816] text-[#FAFBFD] relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 space-y-16 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="text-4xl md:text-6xl font-black font-sora tracking-tight leading-none text-white">
      ...
      {/* ---------------------------------------------------- */}
      {/* STICKY BOTTOM CONVERSIONS CTA BAR (Only visible if showStickyBar is true) */}
      {/* ---------------------------------------------------- */}
      <AnimatePresence>
        {showStickyBar && (
          <motion.div 
            ...
            className="fixed bottom-0 left-0 right-0 z-50 bg-[#050816]/90 backdrop-blur-md border-t border-white/10 py-4 px-6 shadow-[0_-10px_35px_rgba(0,0,0,0.5)]"
          >
