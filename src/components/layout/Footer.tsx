        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col text-left">
            <div className="flex items-center gap-2 mb-6">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#E2FF00]">
          ...
          <div className="flex flex-col text-left">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <Link key={item.name} href={item.href} className="text-white/50 hover:text-[#E2FF00] transition-colors text-xs font-bold">
                  {item.name}
                </Link>
              ))}
            </div>
          ...
          <div className="flex flex-col text-left">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                { name: "Advertise With Us", href: "/marketplace" },
          ...
          {/* Contact & Legal */}
          <div className="flex flex-col text-left">
            <h4 className="text-white font-sora text-xs font-black tracking-widest uppercase mb-6">Contact & Legal</h4>
            <div className="flex flex-col gap-3 mb-6">
              <span className="text-white/50 text-xs font-bold flex items-center gap-1.5">
                <Mail className="w-3.5 h-3.5 text-[#E2FF00]" />
                <a href="mailto:trips@tripvora.com" className="hover:text-white transition-colors">trips@tripvora.com</a>
              </span>
            </div>
            
            <div className="flex flex-wrap gap-x-4 gap-y-2 text-[10px] text-white/30 font-bold border-t border-white/5 pt-4">
