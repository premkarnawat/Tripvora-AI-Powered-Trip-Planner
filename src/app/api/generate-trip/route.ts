...
import type { TripRequest, ItineraryData, Hotel, ActivityItem, RestaurantRecommendation, DayItinerary, DestinationItem, UserPreferenceProfile, RecommendationItem, ValidationBreakdown } from '@/types/trip';
