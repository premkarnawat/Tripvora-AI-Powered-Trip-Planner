...
export default function TripItineraryPage() {
  ...
  // Day-wise journey timeline data
  const dayTimeline = [
    {
      time: "06:30 AM",
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-[32px] overflow-hidden shadow-sm flex flex-col md:flex-row justify-between items-stretch">
          <div className="p-8 flex-1 flex flex-col justify-between space-y-6">
            <div>
              ...
              <h1 className="text-3xl font-black font-sora tracking-tight text-[#0F172A]">Goa Sunset & Beach Escape</h1>
              <p className="text-xs text-[#64748B] mt-1.5 flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-teal-600" /> North & South Goa, India • July 15 - July 20
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs font-bold text-[#64748B] uppercase tracking-wider">
              <div className="border-l-2 border-teal-500 pl-3">
                ...
                <span className="text-[#0F172A] font-extrabold">{dayTimeline.length - 4} Nights / 5 Days</span>
              </div>
              <div className="border-l-2 border-teal-500 pl-3">
